...
LABEL version="2.6.2" \
      ...
      docker_build="docker build -t hackllc/nikto:2.6.2 ." \
      docker_run_basic="docker run --rm hackllc/nikto:2.6.2 -h http://www.example.com" \
      docker_run_advanced="docker run --rm -v $(pwd):/tmp hackllc/nikto:2.6.2 -h http://www.example.com -o /tmp/out.json"
